...
#                 f=open('/Users/nikos/Documents/Fatigue-Detection-Master-Thesis/detections/%s.txt'%path,'a+')
#                 f.write('face %s %s %s %s %s'%(iouRectFormat[0],iouRectFormat[1],iouRectFormat[2],iouRectFormat[3],iou))
#                 iouSum += iou
